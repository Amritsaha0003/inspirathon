    ...
    <Navbar2/>
      <main className="flex-1">
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <EventCard
                ...
                description="Join us for three days of networking, knowledge sharing, and nostalgia on the NIT goa campus."
        ...
        <section id="profile" className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl mb-8">My Profile</h2>
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center space-x-4 mb-6">
                  <Avatar className="h-20 w-20">
                    <AvatarImage src="/image/profileLogo.png" alt="INSPIRATHON" />
                    <AvatarFallback>RK</AvatarFallback>
                  </Avatar>
                  <div>
                    <h3 className="text-2xl font-semibold">INSPIRATHON</h3>
                    <p className="text-gray-500">Class of 2024</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div>
                    <p className="font-medium">Email:</p>
                    <p>Quark@example.com</p>
                  </div>
                  <div>
